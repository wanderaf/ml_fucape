...
def run():
    ...
    with st.spinner("🔄 Executando simulação..."):
        ...
        for i, mes in enumerate(meses_rolling):
            ...
            top_ativos = df_test.sort_values("Proba_Classe1", ascending=False).drop_duplicates("Ticker").head(10).copy()
    ...
    df_result[["Capital"]].to_csv(f"data/results/mlp_capital.csv")
    ...
    if isinstance(shap_values_all, list):
        shap_values_mes = shap_values_all[1]  # classe positiva
